document.addEventListener('DOMContentLoaded', async () => {
  const userStr = localStorage.getItem('logictech_user') || sessionStorage.getItem('logictech_user');
  if (!userStr) {
  ...
  if (avatarEl) avatarEl.textContent = (user.username || 'AD').substring(0,2).toUpperCase();
