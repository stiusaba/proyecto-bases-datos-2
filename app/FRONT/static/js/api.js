...
const NoticiasAPI = {
  getAll: async () => apiGet("/api/noticias/"),  // <--- con barra final
  create: async (data) => apiPost("/api/noticias/", data),
  update: async (id, data) => apiPut(`/api/noticias/${id}`, data),
  delete: async (id) => apiDelete(`/api/noticias/${id}`),
};
